...
@SpringBootTest
class ServerMessageIntegrationTests {
...
//public class ServerMessageIntegrationTests {
//
//	@LocalServerPort
//	private int port;
//
...
//						ServerMessage greeting = (ServerMessage) payload;
//						try {
...
//				});
//				try {
//					session.send("/app/hello", new ClientMessage("Spring"));
//				} catch (Throwable t) {
//					failure.set(t);
//					latch.countDown();
//				}
